      ...
      <div className="max-w-6xl mx-auto relative border-[5px] border-[#002468] border-t-0 rounded-b-[40px] flex flex-col items-center min-h-[650px]">
        ...
        <div className="mt-20 flex flex-col items-center w-full px-4">
          ...
          <nav className="flex gap-8 md:gap-10 mt-16 text-xl md:text-2xl ">
            ...
            <a href="#works" className="hover:opacity-70 transition-opacity">Gallery</a>
          ...
          <div className="flex gap-5 mt-16">
            ...
            <a 
              href="https://www.instagram.com/fillmore_burgers?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-16 h-12 border-[4px] border-[#002468] flex items-center justify-center rounded-xl hover:bg-[#002468] hover:text-[#f4eedd] transition-colors cursor-pointer"
            >
